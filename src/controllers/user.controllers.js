...
const registerUser = asyncHandler( async (req, res) => {
    ...
    */
    ...
    return res
        ...
        throw new ApiError(500, "Something went wrong while creating user and imgs were deleted...")
    }
})
...
const getCurrentUser = asyncHandler( async (req, res) => {
    return res.status(200).json(new ApiResponse(200, req.user, "Currentuser details"))
})
